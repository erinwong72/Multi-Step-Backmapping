...
with open('/home/erin/Documents/DiAMoNDBack/scripts/res_add_dict.pkl', 'rb') as handle:
...
def crd_to_mdtrj(all_seqs, crd_ref_list, crd_gen_list, end_idx_list, 
    ...
    if len(n_sample_list) == 1:
        ...
        for idx, (start, end, name, n_sample) in enumerate(
            ...
            trj_sample_list.append(trj_gen)
        sample_rmsd_mean = sample_rmsd(trj_sample_list)
        print(f'Mean sample RMSD: {sample_rmsd_mean}')
        return sample_rmsd_mean
