...
parser.add_argument("-f", "--feat_dir", type=str, default='/home/erin/Documents/DiAMoNDBack/data/processed_features')
...
if finetune == 'PDB': finetune = '/home/erin/Documents/DiAMoNDBack/trained_models/train_PDB/32-1-2-4-8-b128-lr2.0e-05-gamma0.9999965988084024--rescale20.0-/model-10.pt'
elif finetune == 'PDB_DES-FT': finetune = '/home/erin/Documents/DiAMoNDBack/trained_models/train_PDB_DES-FT/32-1-2-4-8-b128-lr1.0e-05-gamma1.0--rescale20.0-/model-15.pt'
elif finetune == 'finetune_plpro': finetune = '/home/erin/Documents/DiAMoNDBack/trained_models/train_finetune_plpro/32-1-2-4-8-b128-lr1.0e-05-gamma1.0--rescale20.0-/model-14.pt'
elif finetune == 'finetune_eIF4E': finetune = '/home/erin/Documents/DiAMoNDBack/trained_models/train_finetune_eIF4E/32-1-2-4-8-b128-lr1.0e-05-gamma1.0--rescale20.0-/model-16.pt'
