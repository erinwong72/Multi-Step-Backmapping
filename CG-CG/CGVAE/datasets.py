...
PROTEINFILES = {'covid': {'traj_paths': "../data/DESRES-Trajectory_sarscov2-11441075-no-water-zinc-glueCA/sarscov2-11441075-no-water-zinc-glueCA/sarscov2-11441075-no-water-zinc-glueCA-00*.dcd", 
                ...
                'chignolin': {'traj_paths': "../data/chignolin/filtered/e1*/*.xtc", 
                              'pdb_path': '../data/chignolin/filtered/filtered.pdb', 
                              'file_type': 'xtc'}, 
                'dipeptide': 
                ...
                'PED3_RBCG':
                            ...
                            'traj_paths': '../data/PED/RBCG/PED00003e001.xtc',
                            'file_type': 'pdb'
                            },
                'PED17_RBCG':
...
def get_cg_and_xyz(traj, args, config, cg_method, n_cgs=None, mapshuffle=0.0, mapping=None, frames=None):
    ...
    if cg_method in ['minimal', 'alpha']:
        ...
        if mapping == None:
            ...
            mapping = learn_map(traj, reg_weight=config.cgae_reg_weight, n_cgs=n_cgs, n_atoms=n_atoms, batch_size=32)
            dataset_label = config.dataset
            print(mapping)
            torch.save(mapping, f'/home/erin/Documents/CoarseGrainingVAE/mapping_{dataset_label}_ncgs{config.n_cgs}.pt')
        else:
            mapping = mapping 
