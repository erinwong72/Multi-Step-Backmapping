...
#SBATCH --error=/gpfs/scratch/eswong/CoarseGrainingVAE/logs/rerun_FG.%J.err
#SBATCH --output=/gpfs/scratch/eswong/CoarseGrainingVAE/logs/rerun_FG.%J.out
...
# delete the file
#rm sweep_id.txt
for id in s1954b2s; do
    python run_ala_ddp_rerun.py --run_id $id --queue "a100-long" --n_gpus 4 --dataset "eIF4E" --new_seed 1234 &
wait
done
#wait
